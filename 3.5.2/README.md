...
```
docker pull cyversevice/shiny-verse:3.5.2
```

```
docker run -it --rm -d -p 3838:3838 cyversevice/shiny-verse:3.5.2
```
...
```
docker run -it --rm -p 3838:3838 -e REDIRECT_URL=http://localhost:3838 cyversevice/shiny-verse:3.5.2
```

To build your own container with a Dockerfile and additional dependencies, pull the pre-built image from DockerHub:

```
FROM cyversevice/shiny-verse:3.5.2
```
...
Follow the instructions in the [VICE manual for integrating your own tools and apps](https://cyverse-visual-interactive-computing-environment.readthedocs-hosted.com/en/3.5.2/developer_guide/building.html).
